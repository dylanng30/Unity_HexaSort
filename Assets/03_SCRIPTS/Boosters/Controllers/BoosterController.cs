...
namespace HexaSort.Boosters.Controllers
{
    public class BoosterController : MonoBehaviour
    {
        ...
        {
<<<<<<< Updated upstream:Assets/03_SCRIPTS/Boosters/04_Presentation/Controllers/BoosterController.cs
=======
            Debug.Log(currentSelectedBooster.BoosterType);
            
>>>>>>> Stashed changes:Assets/03_SCRIPTS/Boosters/Controllers/BoosterController.cs
